...
integer :: valence_Z, & ! protons
           valence_N, & ! neutrons
           valence_A    ! nucleons
                        
!!! Number of core particles 
integer :: core_Z, & ! protons
           core_N, & ! neutrons
           core_A    ! nucleons

!!! Total number of particles
integer :: nucleus_Z, & ! protons
           nucleus_N, & ! neutrons
           nucleus_A    ! nucleons
...
character(len=*), parameter :: format1 = "(1a7,2x,1i7,1x,1i7,1x,1i7)"

print '(60("%"),/,27x,"NUCLEUS",26x,/,60("%"),//, &
      & "Part \ No.",5x,"Z",7x,"N",7x,"A",/,32("-"))'
