...
!!! Allocate hamil_H1cpd (not really needed but prettier)
...
! subroutine set_hamiltonian_2body                                             !
!                                                                              ! 
! Reads the 2-body part of the interaction from file "hamil_f2b" and uncouples ! 
...
! T = 5   nn nn                                                                ! 
!                                                                              !
! Input: a,b,c,d = values of the bra/ket indices                               !
!                                                                              !
! Output: sumando = value of the uncoupled matrix element                      !
!------------------------------------------------------------------------------!
...
! T = 5   nn nn                                                                ! 
!                                                                              !
! Input: Tini = initial isospin index                                          !
!        perm = permutation of indices                                         !
!        htype = type of Hamiltonian                                           !
!                                                                              !
! Output: Tfin = final isospin index                                           !
!------------------------------------------------------------------------------!
...
!   < H > = H_0 + Tr(H_1 * rhoLR) + 1/2 Tr(gammaLR * rhoLR)                    !
!           + 1/2 Tr(deltaLR * kappaRL)                                        !
!                                                                              !
! Input: ndim = dimension of the sp basis                                      !
!        rhoLR,kappLR = transition densities                                   !
!        gammaLR,deltaLR = transitition fields                                 !
!                                                                              !
! Output: energy = expectation value of the energy                             !
!------------------------------------------------------------------------------!
