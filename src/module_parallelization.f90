...
integer(i64) :: paral_myangles, & ! Number of angles for a given team
                paral_myoffset    ! Offset for angles for a given team
...
! ment, size, rank of processes) which compute different angles.               !
!------------------------------------------------------------------------------!
subroutine set_parallel_teams            
