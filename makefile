...
# This is an example of makefile to compile TAURUS_pav. The code requires the
...
$(OBJDIR)/module_isospin.o: $(OBJDIR)/module_basis.o

$(OBJDIR)/module_multipoles.o: $(OBJDIR)/module_basis.o

$(OBJDIR)/module_radius.o: $(OBJDIR)/module_basis.o

$(OBJDIR)/module_operators.o: $(OBJDIR)/module_particlenumber.o $(OBJDIR)/module_angularmomentum.o \
                              $(OBJDIR)/module_isospin.o $(OBJDIR)/module_multipoles.o \
...
$(OBJDIR)/module_initialization.o: $(OBJDIR)/module_projection.o 
