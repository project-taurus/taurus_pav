...
# This is an example of script to compile TAURUS_pav. The code requires the
...
filelist="module_constants.xx module_mathmethods.xx MPI module_nucleus.xx      \
          module_basis.xx module_hamiltonian.xx                                \
          module_particlenumber.xx module_angularmomentum.xx module_isospin.xx \
          module_multipoles.xx module_radius.xx module_operators.xx            \
          module_wavefunctions.xx module_fields.xx module_projection.xx        \
          module_initialization.xx subroutines_pfaffian.yy"
